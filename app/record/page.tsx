import { RecordDashboard } from "@/components/widgets/record-dashboard";
...
export default function RecordPage() {
  return (
    <div className="min-h-screen flex flex-col items-center bg-[var(--c-background)]">
      ...
      <main className="w-full max-w-[1200px] flex-1 py-10 px-4 md:px-10 flex mt-8">
        <RecordDashboard />
      </main>
    </div>
  );
